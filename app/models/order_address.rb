class OrderAddress
  ...
  def save
    ...
    Address.create(order_id: order.id, post_code: post_code, prefecture_id: prefecture_id, city: city, street_name: street_name,
                   bldg_name: bldg_name, phone_number: phone_number)
  end
end
