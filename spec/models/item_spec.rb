  ...
  describe '商品の出品登録' do
    ...
    context '出品ができないとき' do
      ...
      it '発送元の地域の情報が空欄だと出品できない' do
        ...
        @item.valid?
        expect(@item.errors.full_messages).to include("Ship area can't be blank", 'Ship area is not a number')
      end
      ...
      it '発送までの日数の情報が空欄だと出品できない' do
        ...
        @item.valid?
        expect(@item.errors.full_messages).to include("Ship days can't be blank", 'Ship days is not a number')
      end
      it '価格が空欄だと出品できない' do
        @item.price = nil
        @item.valid?
